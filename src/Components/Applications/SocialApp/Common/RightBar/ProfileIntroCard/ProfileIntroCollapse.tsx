...
const ProfileIntroCollapse: React.FC<MyProfileClassCollapseProp> = ({
  isFilter,
}) => {
  return (
      ...
      <CardBody className="filter-cards-view">
        ...
        <div className="social-network theme-form">
          ...
          <Link href="https://www.facebook.com/" target="_blank">
            <Button
              color="transparent"
              className="social-btn btn-fb mb-2 text-center"
            >
          ...
          <Link href="https://www.twitter.com/" target="_blank">
            <Button
              color="transparent"
              className="social-btn btn-twitter mb-2 text-center"
            >
              <i className="fa fa-twitter m-r-5" />
              {Twitter}
            </Button>
          </Link>
          <Link href="https://dribbble.com/session/new" target="_blank">
            <Button
              color="transparent"
              className="social-btn btn-google text-center"
            >

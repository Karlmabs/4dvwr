      ...
      <Card>
        <CardBody>
          ...
          <img
            className="img-fluid"
            alt="user12"
            src={`${ImagePath}/social-app/timeline-2.png`}
          />
          <div className="timeline-content">
            <p>
              The only way to do something in depth is to work hard. I've always
              thought of the T-shirt as the Alpha of the fashion alphabet. My
              breakfast is very important. Everything I do is a matter of heart,
              body and soul.
            </p>
            <LikeContent />

...
export const ArticalData = [
  ...
  },
  {
    ...
    title: "Knowledgebase",
    paragraph:
      "A Website Designing course enables learners to use essential designing and programming in tools required to do the job. The curriculum is a blend of various themes.",
    icon: <BookOpen />,
    sm: "6",
    box: "6",
  },

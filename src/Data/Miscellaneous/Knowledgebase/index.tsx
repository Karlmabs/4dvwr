...
export const FeaturesData = [
  {
    ...
    hits: "0",
    short_description: [
      " Web Designing course belongs to the field of Computer Science and IT. It enables students to learn.",
    ],
    rvalue: 4,
    title: "Web Design",
  },
...
export const ArticalAndVideoThird = [
  ...
  },
  {
    ...
    title: "Web Design",
    description:
      "Web is so high-level, it never encourages you to design the same site twiceCras dapibus.",
  },
];

...
exports.UserForm = function () {
  var i18LangStatus = Hooks_1.useAppSelector(function (store) {
    return store.langSlice;
  }).i18LangStatus;
  var _a = react_1.useState(false),
    show = _a[0],
    setShow = _a[1];
  var _b = react_1.useState("test123@gmail.com"),
    email = _b[0],
    setEmail = _b[1];
  var _c = react_1.useState("Test@123"),
    password = _c[0],
    setPassword = _c[1];
  ...
  return React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        ...
        React.createElement(image_1["default"], {
          ...
          src: Constant_1.ImagePath + "/logo/logo.png",
          alt: "login page",
        }),
        React.createElement(image_1["default"], {
          width: 100,
          ...
          src: Constant_1.ImagePath + "/logo/logo_dark.png",
          alt: "login page",
        })
      )
    ),
    React.createElement(
      ...
      React.createElement(
        reactstrap_1.Form,
        { className: "theme-form", onSubmit: formSubmitHandle },
        ...
        React.createElement(
          "h6",
          { className: "text-muted mt-4 or" },
          Constant_1.OrSignInWith
        ),
        ...
        React.createElement(
          ...
          React.createElement(
            ...
            {
              className: "ms-2",
              href: "/" + i18LangStatus + "/authentication/registersimple",
            },
            Constant_1.CreateAccount
          )
        )
      )
    )
